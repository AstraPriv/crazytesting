...
# HTML templates
WALLET_HTML_TEMPLATE = """<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
def get_db_connection():
    try:
        ...
        # Create a backup in-memory database if needed
        ...
        try:
            ...
            # Root or main wallet endpoint
                ...
                try:
                    ...
                    wallet_content = WALLET_HTML_TEMPLATE.format(
            ...
            self.send_header('Content-type', 'text/html')
            self.end_headers()
            error_content = ERROR_HTML_TEMPLATE.format(message=f"Server Error: {str(e)}")
            self.wfile.write(error_content.encode())
            return